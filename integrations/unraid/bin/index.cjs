...
var require_error = __commonJS({
  "node_modules/@redplanethq/sdk/node_modules/commander/lib/error.js"(exports) {
    init_cjs_shims();
...
var require_argument = __commonJS({
  "node_modules/@redplanethq/sdk/node_modules/commander/lib/argument.js"(exports) {
    init_cjs_shims();
...
var require_help = __commonJS({
  "node_modules/@redplanethq/sdk/node_modules/commander/lib/help.js"(exports) {
    init_cjs_shims();
...
var require_option = __commonJS({
  "node_modules/@redplanethq/sdk/node_modules/commander/lib/option.js"(exports) {
    init_cjs_shims();
    var { InvalidArgumentError: InvalidArgumentError2 } = require_error();
    var Option2 = class {
      /**
...
var require_suggestSimilar = __commonJS({
  "node_modules/@redplanethq/sdk/node_modules/commander/lib/suggestSimilar.js"(exports) {
    init_cjs_shims();
    var maxDistance = 3;
...
var require_command = __commonJS({
  "node_modules/@redplanethq/sdk/node_modules/commander/lib/command.js"(exports) {
    init_cjs_shims();
...
var require_commander = __commonJS({
  "node_modules/@redplanethq/sdk/node_modules/commander/index.js"(exports) {
    init_cjs_shims();
...
async function executeGraphQLQuery(config, query, variables) {
  var _a5, _b;
  const url2 = `${config.serverUrl}/graphql`;
  try {
    ...
    if (axios_default.isAxiosError(error)) {
      throw new Error(
        `Unraid API request failed: ${(_a5 = error.response) == null ? void 0 : _a5.status} ${(_b = error.response) == null ? void 0 : _b.statusText}`
      );
    }
    throw error;
  }
...
async function handleSchedule(config, state) {
  var _a5, _b, _c, _d;
  try {
    const unraidConfig = config;
    if (!(unraidConfig == null ? void 0 : unraidConfig.serverUrl) || !(unraidConfig == null ? void 0 : unraidConfig.apiKey)) {
      return [];
    }
    ...
    if (metricsData.status === "fulfilled" && metricsData.value) {
      ...
      currentState.lastMetricsCheck = (/* @__PURE__ */ new Date()).toISOString();
    }
    if (systemInfo.status === "fulfilled" && systemInfo.value) {
      ...
      if ((_d = (_c = (_b = (_a5 = systemInfo.value) == null ? void 0 : _a5.info) == null ? void 0 : _b.versions) == null ? void 0 : _c.core) == null ? void 0 : _d.unraid) {
        currentState.serverVersion = systemInfo.value.info.versions.core.unraid;
      }
    }
    currentState.lastSyncTime = (/* @__PURE__ */ new Date()).toISOString();
    messages.push({
      type: "state",
      data: currentState
    });
...
async function fetchDockerContainers(config) {
  const query = `
    query {
      docker {
        containers {
  ...
  `;
  try {
    return await executeGraphQLQuery(config, query);
  } catch (error) {
    console.error("Error fetching Docker containers:", error);
    return null;
  }
}
async function fetchVMs(config) {
  const query = `
    query {
      vms {
        domains {
...
async function fetchArrayStatus(config) {
  const query = `
    query {
      array {
        state
...
async function fetchSystemInfo(config) {
  const query = `
    query {
      info {
        id
...
function processDockerContainers(data, previousState, serverUrl) {
  const activities = [];
  const newState = {};
...
function processVMs(data, previousState, serverUrl) {
  const activities = [];
  const newState = {};
  if (!data.vms.domains) {
    return { activities, newState };
...
function processArrayStatus(data, previousState, serverUrl) {
  const activities = [];
...
function processMetrics(data, serverUrl) {
  var _a5, _b, _c, _d;
  const activities = [];
  if (((_b = (_a5 = data.metrics) == null ? void 0 : _a5.cpu) == null ? void 0 : _b.percentTotal) > 80) {
    activities.push(
      createActivityMessage(
  ...
  if (((_d = (_c = data.metrics) == null ? void 0 : _c.memory) == null ? void 0 : _d.percentTotal) > 90) {
    activities.push(
      createActivityMessage(
...
function processSystemInfo(data, previousVersion, serverUrl) {
  var _a5, _b, _c;
  const currentVersion = (_c = (_b = (_a5 = data == null ? void 0 : data.info) == null ? void 0 : _a5.versions) == null ? void 0 : _b.core) == null ? void 0 : _c.unraid;
...
async function integrationCreate(data) {
  ...
  `;
  try {
    const response = await executeGraphQLQuery(config, query);
    if (!response.info) {
      throw new Error("Could not fetch Unraid server information");
    }
    const serverInfo = response.info;
    const version = ((_b = (_a5 = serverInfo.versions) == null ? void 0 : _a5.core) == null ? void 0 : _b.unraid) || "unknown";
    ...
    return [
      {
        ...
        data: {
          settings: {
            ...
            version,
            model: (_c = serverInfo.system) == null ? void 0 : _c.model,
            baseboard: (_d = serverInfo.baseboard) == null ? void 0 : _d.model,
            username: (_e = response.me) == null ? void 0 : _e.name
          },
          accountId,
          config: {
            serverUrl: config.serverUrl,
...
var UnraidCLI = class extends IntegrationCLI {
  constructor() {
    super("unraid", "1.0.0");
  }
  ...
  async getSpec() {
    return {
      ...
      key: "unraid",
      description: "Monitor and track your Unraid server activity including Docker containers, VMs, array status, and system metrics.",
      icon: "server",
      auth: {
        api_key: {
